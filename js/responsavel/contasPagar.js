...
var requestURL = 'https://maxel-uds.github.io/JSON-Trabalho-TES/contasPagar.json';
...
function getContas() {
    ...
    if(aluno) {
        ...
        aluno["materias"].forEach(atividade => {
...
function createTable(tabela) {
    ...
    atividade.textContent = `Disciplina`;
